const translations = {
  ja: {
    ...
    authRequiredHint: "登録またはログインすると、Tellnow の通話スペースを使えます。"
  },
  en: {
    dir: "ltr",
    topBadge: "Voice Spaces",
    ...
    authRequiredHint: "Sign up or log in to use Tellnow spaces."
  }
};
